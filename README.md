<img src="banner.png" alt="Muhammad Shah — I build AI systems that keep working after the demo." width="100%">
...
|---|---|
| [AI-Engineer-Role-Task](https://github.com/Muhammad-Shah/AI-Engineer-Role-Task) | Database chatbot — natural language to SQL and MongoDB over your own databases; FastAPI, a ReAct agent, streamed responses, similarity-based caching |
| [Meeting-Bot-Assessment](https://github.com/Muhammad-Shah/Meeting-Bot-Assessment) | Upload a meeting transcript and chat with it — FastAPI and LangChain |
| [RAG-Essentials](https://github.com/Muhammad-Shah/RAG-Essentials) | Retrieval-augmented generation reference build with LangChain and FAISS, plus an AWS EC2 deployment guide |
| [finetuning-llms](https://github.com/Muhammad-Shah/finetuning-llms) | Working notebooks for fine-tuning large language models |
| [openai_realtime_react_voice_agent](https://github.com/Muhammad-Shah/openai_realtime_react_voice_agent) | Voice agent on the OpenAI Realtime API with a React client ([Deepgram variant](https://github.com/Muhammad-Shah/deep-gram-voice-agent)) |
| [HealthConnect--AI--HealthCare](https://github.com/Muhammad-Shah/HealthConnect--AI--HealthCare) | RAG doctor-recommendation assistant — LangChain and ChromaDB behind an interactive Q&A flow |
